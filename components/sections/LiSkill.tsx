...
export default function LiSkill({ skillName, imgSrc }: LiSkillProps) {
  return (
    ...
    >
      <div className="relative w-24 h-24 shrink-0 border-4 border-foreground bg-white flex items-center justify-center group-hover:bg-brand-secondary transition-colors">
        <img
          src={imgSrc}
          alt={skillName}
